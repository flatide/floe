...
| M0-D4 | M4a-1/2의 scene·표시 anchor·취소에 M4a-3의 owner/view/connection 검증·표시 ACK+write receipt·안전한 결과 DTO 연결 | [M4 기록](WEBUI_M4.ko.md). layout owner WebSocket query 지원, deck 미지원. 브라우저의 실제 표시 선택·좌표/DPR·늦은 결과 거부 UI는 다음 단계 |
