...
| M0-D4 | M4a-1/2의 scene·표시 anchor·취소, M4a-3의 owner/connection·표시 ACK+write receipt·DTO, M4a-4의 브라우저 표시/DPR·선택/스냅·늦은 결과 거부 | [M4 기록](WEBUI_M4.ko.md). layout 지원, deck 미지원. 결정적 UI/전송 gate 구현; 실제 브라우저 수용·수동 ruler/clip은 남음 |
