...
| M0-D4 | M4a-1~4의 scene/표시 anchor·owner receipt·선택/스냅, M4a-5의 Rust 수동 ruler | [M4 기록](WEBUI_M4.ko.md). geometry query는 layout만, cursor-only ruler는 deck/summary도 지원. 실제 브라우저 수용·자동 gap/CD 통합·clip은 남음 |
