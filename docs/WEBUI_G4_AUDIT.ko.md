...
갱신: 2026-09-16, M4g-24a(DRC 교체 선행 게시 보호). 상위 [계획](WEBUI_PLAN.ko.md), 원래 범위
...
M4g-24a는 새 입력 등록과 기존 저장 초안 사이의 보호 경계만 추가했다. 실행 중
DRC/SVRF 교체와 레벨 재선택3건을 완료로 바꾸지 않는다([M4 §79](WEBUI_M4.ko.md)).
