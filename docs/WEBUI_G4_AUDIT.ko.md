...
갱신: 2026-09-16, M4g-16a(슬롯 계약 감사; 제품 구현은 M4g-15a). 상위 [계획](WEBUI_PLAN.ko.md), 원래 범위
...
| UI-03 레이어·스타일 | Rust 선택/CAS, palette/presets/settings/defaults; GTK 원본 선택·접힘·상속 oracle, HTTP/DOM gate. M4g-16a 슬롯 원본 계약324편집/80메뉴 | 실제 선택·다중 스타일·기본값 게시 화면 수용. 개발 bitmap **슬롯** 편집은 미이관([계약/후속 gate](WEBUI_BITMAP_SLOTS.ko.md)) |
