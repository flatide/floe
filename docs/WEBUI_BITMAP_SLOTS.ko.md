...
**Rust 모델·설정 v2·슬롯 API와 웹 프리셋/편집 UI를 연결했다.**
2026-09-18 실제 Chrome의 초안·참조/비참조 반영·reload·Reset·취소는
[브라우저 §5.1](WEBUI_BROWSER_ACCEPTANCE.ko.md#51-bitmap-슬롯과-오버레이-스크롤바-클릭)을
확인했다. 연속 stroke 보간, 실제 v2 다운로드/import·그룹 상속·Firefox 수용까지
완료했다는 뜻은 아니다. 빠른 드래그의 샘플 사이 빈 셀은 아래 GTK와 같은 기존 동작이다.
