...
가시 레이어에만 허용하며, 독립 DRC panel/선택/읽기는 M2b-3b2에 남는다.
...
| M2 | 로컬 DRC·공유 인증/권한·follow 전송·독립 explore 렌더/query/룰러 구현 | 독립 DRC 공유·공유 URL/UI·원격 배포 및 수용 (`shares=false`, loopback-only) |
