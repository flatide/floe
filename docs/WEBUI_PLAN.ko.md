...
작성 2026-08-29, 갱신 2026-09-15(M4g-9b 승인된 색인→재열기 UI).
...
2026-09-15, M4g-9b 기준. **로컬 Rust/web 대체 기능은 후반부지만 전체 계획의
...
미색인 파일의 **동의→색인→자동 재열기 UI**는 M4g-9b에서 연결했다. 다음 로컬 구현은
bare FILE, 미이관 view 옵션·파일 형식/조작 차이의 명시 처리 등 M0 대조표 잔여다.
