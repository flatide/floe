...
2026-09-16, M4g-13 기준. **로컬 Rust/web 대체 기능은 후반부지만 전체 계획의
...
입력기의 누락을 이관했다([M4 §63](WEBUI_M4.ko.md)). 다음 로컬 단계는 사용자가
선택한 reviewer별 자동 저장 opt-in이며, reviewer 읽기 선택도 별도로 남는다.
