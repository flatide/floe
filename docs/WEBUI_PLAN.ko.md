...
작성 2026-08-29, 갱신 2026-09-16(M4g-19 휠 입력 정책).
...
2026-09-16, M4g-19 기준. **로컬 Rust/web 대체 기능은 후반부지만 전체 계획의
...
주장하지 않는다. `--dump`의 승인된 브라우저 보관/다운로드 구현·GTK 진단/애니메이션 PNG 경계와 실제 화면 수용은
...
- 2026-09-16: `--dump` 대체는 **브라우저에 최근 프레임·합성 화면을 보관하고
  ...
  저장 정책은 확정됐으며 bounded 보관·UI·검증 구현은 후속 단계다.
