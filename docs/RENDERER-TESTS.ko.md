...
- **도형 픽셀 규칙 — area-true (2026-09-22, 사용자 결정, 뷰어 기본)**: 아래 §4의 KLayout 규칙은
  ...
  50 % 남는다). 그 픽셀들에 레이어 fill, 테두리가 외곽선. 명세: **개별 폭의 정수 부분과 평균 폭을
  ...
  측정(게이트, 0/¼/½/¾ px pan의 켜진 열 비율): 폭 우선 사각형 1.5/1.5 px 격자 0.513 전 위상(픽셀
  중심일 때 0.667/0.333/0.333/0.667), 3.8/1.2 px 0.763~0.771(덮임 0.762), 비정수 pitch 3.3/1.4 px
  0.718~0.724(0.704), 폭이 섞인 이웃 0.500~0.506(0.524).
