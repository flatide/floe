...
for (const file of ['protocol.js', 'gestures.js', 'panel-state.js', 'rulers.js', 'drc-groups.js', 'drc.js', 'app.js']) {
...
for (const file of ['protocol.test.cjs', 'gestures.test.cjs', 'client.test.cjs', 'drc.test.cjs', 'drc-navigation.test.cjs', 'drc-markers.test.cjs', 'rulers.test.cjs', 'drc-cd.test.cjs', 'drc-groups.test.cjs', 'drc-box.test.cjs', 'panel-state.test.cjs']) {
