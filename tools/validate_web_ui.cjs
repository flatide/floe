...
for (const file of ['protocol.js', 'gestures.js', 'panel-state.js', 'rulers.js', 'drc-groups.js', 'drc-build.js', 'drc.js', 'app.js']) {
...
for (const file of ['drc-build.test.cjs', 'drc-build-panel.test.cjs']) {
