...
.venv/bin/python -B tools/validate_cache_migration.py "$FLOE2_SMOKE_SRC"
.venv/bin/python -B tools/validate_web_cli_inventory.py
.venv/bin/python -B tools/validate_native_revision.py
.venv/bin/python -B tools/validate_web_selfcheck.py
.venv/bin/python -B tools/validate_web_portable.py
.venv/bin/python tools/validate_app_render.py "$FLOE2_SMOKE_SRC"
.venv/bin/python -B tools/validate_layerprops.py "$FLOE2_SMOKE_SRC"
.venv/bin/python -B tools/validate_layer_defaults.py "$FLOE2_SMOKE_SRC"
.venv/bin/python -B tools/validate_layer_palette.py
.venv/bin/python -B tools/validate_palette_styles.py
.venv/bin/python -B tools/validate_display_test.py
.venv/bin/python -B tools/validate_app_clip.py "$FLOE2_SMOKE_SRC"
.venv/bin/python -B tools/validate_managed_clip.py
.venv/bin/python -B tools/validate_app_captures.py "$FLOE2_SMOKE_SRC"
.venv/bin/python -B tools/validate_fe_embed.py
.venv/bin/python -B tools/validate_drc_captures.py "$FLOE2_SMOKE_SRC"
.venv/bin/python tools/validate_view_controller.py "$FLOE2_SMOKE_SRC"
.venv/bin/python tools/validate_zoom_band.py
.venv/bin/python tools/validate_minimap.py
.venv/bin/python tools/validate_depth_keys.py
.venv/bin/python -B tools/validate_web_wheel.py
.venv/bin/python -B tools/validate_worker_queries.py
.venv/bin/python tools/validate_view_stream.py "$FLOE2_SMOKE_SRC"
.venv/bin/python tools/validate_managed_index.py "$FLOE2_SMOKE_SRC"
.venv/bin/python tools/validate_owner_service.py "$FLOE2_SMOKE_SRC"
.venv/bin/python tools/validate_web_cli.py "$FLOE2_SMOKE_SRC"
.venv/bin/python -B tools/validate_web_local_sharing.py "$FLOE2_SMOKE_SRC"
.venv/bin/python -B tools/validate_display_cli.py
.venv/bin/python -B tools/validate_display_input.py
.venv/bin/python -B tools/validate_web_handoff.py "$FLOE2_SMOKE_SRC"
.venv/bin/python -B tools/validate_web_browse.py "$FLOE2_SMOKE_SRC"
.venv/bin/python -B tools/validate_web_file_display.py
.venv/bin/python -B tools/validate_web_startup.py "$FLOE2_SMOKE_SRC"
.venv/bin/python -B tools/validate_instance_key.py
.venv/bin/python -B tools/validate_web_drc.py "$FLOE2_SMOKE_SRC"
...
.venv/bin/python -B tools/validate_web_review_budget.py "$FLOE2_SMOKE_SRC"
...
.venv/bin/python -B tools/validate_web_drc_open.py "$FLOE2_SMOKE_SRC"
.venv/bin/python -B tools/validate_web_drc_rules.py "$FLOE2_SMOKE_SRC"
...
# Every in-scope GTK menu path now has a linked replacement. This inventory
# remains a linkage gate, not functional parity or actual browser acceptance.
.venv/bin/python -B tools/validate_web_menu_inventory.py --require-complete
...
.venv/bin/python -B tools/validate_svrf_native.py
