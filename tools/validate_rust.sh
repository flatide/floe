...
jobdeck representatives gen_main01 fit_budget sub_cut_box shape_cut write_once layer_decode area_true density_stack rust_renderer klayout"
alias_gates() {
    case "$1" in
        ...
        render)   echo "unit_render rust_renderer representatives fit_budget sub_cut_box shape_cut write_once layer_decode area_true density_stack render_goldens render_speckle render_frames klayout" ;;
...
if gate density_stack; then RAN="$RAN density_stack"
