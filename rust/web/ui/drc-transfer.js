...
(function(root){
    ...
    function bind(o){
        ...
        render();return {attach:function(v){available={notes:!!v.notes,waives:!!v.waives};const first=!enabled;enabled=available.notes||available.waives;if(first&&enabled){return refresh();}changed();},changed:changed,refresh:refresh,
