...
(function(root){
    ...
    function bind(o){
        ...
        function render(){const available=controls();el('gl-rows').textContent='';
        ...
        function reset(){cancel();identity=loaded='';rows=[];ready=waiting=false;start=0;next=null;total=allTotal=0;fold={closed:false,exceptions:[]};render();}
        ...
        render();return {changed:changed,reset:reset};
    }
